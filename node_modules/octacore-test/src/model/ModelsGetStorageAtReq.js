...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsGetStorageAtReq = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsGetStorageAtReq model module.
   * @module model/ModelsGetStorageAtReq
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsGetStorageAtReq</code>.
   * @alias module:model/ModelsGetStorageAtReq
   * @class
   * @param address {String} 
   * @param chains {Array.<String>} 
   * @param key {String} 
   */
  var exports = function(address, chains, key) {
  ...
  /**
   * Constructs a <code>ModelsGetStorageAtReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsGetStorageAtReq} obj Optional instance to populate.
   * @return {module:model/ModelsGetStorageAtReq} The populated <code>ModelsGetStorageAtReq</code> instance.
   */
