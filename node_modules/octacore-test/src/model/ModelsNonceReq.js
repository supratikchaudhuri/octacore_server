...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsNonceReq = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsNonceReq model module.
   * @module model/ModelsNonceReq
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsNonceReq</code>.
   * @alias module:model/ModelsNonceReq
   * @class
   * @param address {String} TODO: ADD ADDRESS CHECK IN VALIDATION
   * @param chains {Array.<String>} 
   */
  var exports = function(address, block_number,chains) {
  ...
  /**
   * Constructs a <code>ModelsNonceReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsNonceReq} obj Optional instance to populate.
   * @return {module:model/ModelsNonceReq} The populated <code>ModelsNonceReq</code> instance.
   */
  ...
  /**
   * TODO: ADD ADDRESS CHECK IN VALIDATION
