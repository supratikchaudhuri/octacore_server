...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsDomainReq = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsDomainReq model module.
   * @module model/ModelsDomainReq
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsDomainReq</code>.
   * @alias module:model/ModelsDomainReq
   * @class
   * @param domain {String} 
   */
  ...
  /**
   * Constructs a <code>ModelsDomainReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsDomainReq} obj Optional instance to populate.
   * @return {module:model/ModelsDomainReq} The populated <code>ModelsDomainReq</code> instance.
   */
