...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsGetNFTRequestBody', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsGetNFTRequestBody();
      });

      it('should create an instance of ModelsGetNFTRequestBody', function() {
        // TODO: update the code to test ModelsGetNFTRequestBody
        expect(instance).to.be.a(Octacore.ModelsGetNFTRequestBody);
      });
