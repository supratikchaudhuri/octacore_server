...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsBlockNumberIndex', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsBlockNumberIndex();
      });

      it('should create an instance of ModelsBlockNumberIndex', function() {
        // TODO: update the code to test ModelsBlockNumberIndex
        expect(instance).to.be.a(Octacore.ModelsBlockNumberIndex);
      });
