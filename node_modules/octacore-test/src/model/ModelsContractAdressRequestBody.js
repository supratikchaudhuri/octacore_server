...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsContractAdressRequestBody = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsContractAdressRequestBody model module.
   * @module model/ModelsContractAdressRequestBody
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsContractAdressRequestBody</code>.
   * @alias module:model/ModelsContractAdressRequestBody
   * @class
   */
  var exports = function(contract_address,chains) {
    this.contract_address =contract_address;
    this.chains=chains;
  };

  /**
   * Constructs a <code>ModelsContractAdressRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsContractAdressRequestBody} obj Optional instance to populate.
   * @return {module:model/ModelsContractAdressRequestBody} The populated <code>ModelsContractAdressRequestBody</code> instance.
   */
