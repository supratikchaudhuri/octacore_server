...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsAddressBalanceReq = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsAddressBalanceReq model module.
   * @module model/ModelsAddressBalanceReq
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsAddressBalanceReq</code>.
   * @alias module:model/ModelsAddressBalanceReq
   * @class
   * @param address {String} 
   * @param chains {Array.<String>} 
   */
  var exports = function(address, chains,unit) {
  ...
  /**
   * Constructs a <code>ModelsAddressBalanceReq</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsAddressBalanceReq} obj Optional instance to populate.
   * @return {module:model/ModelsAddressBalanceReq} The populated <code>ModelsAddressBalanceReq</code> instance.
   */
  ...
  /**
   * @member {module:model/ModelsAddressBalanceReq.UnitEnum} unit
   */
