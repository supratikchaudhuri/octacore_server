...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsContractAdressRequestBody', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsContractAdressRequestBody();
      });

      it('should create an instance of ModelsContractAdressRequestBody', function() {
        // TODO: update the code to test ModelsContractAdressRequestBody
        expect(instance).to.be.a(Octacore.ModelsContractAdressRequestBody);
      });
