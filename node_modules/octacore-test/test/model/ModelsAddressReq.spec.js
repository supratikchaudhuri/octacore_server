...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsAddressReq', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsAddressReq();
      });

      it('should create an instance of ModelsAddressReq', function() {
        // TODO: update the code to test ModelsAddressReq
        expect(instance).to.be.a(Octacore.ModelsAddressReq);
      });
