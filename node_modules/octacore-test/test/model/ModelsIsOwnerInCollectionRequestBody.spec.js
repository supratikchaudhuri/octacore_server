...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsIsOwnerInCollectionRequestBody', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsIsOwnerInCollectionRequestBody();
      });

      it('should create an instance of ModelsIsOwnerInCollectionRequestBody', function() {
        // TODO: update the code to test ModelsIsOwnerInCollectionRequestBody
        expect(instance).to.be.a(Octacore.ModelsIsOwnerInCollectionRequestBody);
      });

      it('should have the property accountAddress (base name: "account_address")', function() {
        // TODO: update the code to test the property accountAddress
        expect(instance).to.have.property('accountAddress');
        // expect(instance.accountAddress).to.be(expectedValueLiteral);
      });
