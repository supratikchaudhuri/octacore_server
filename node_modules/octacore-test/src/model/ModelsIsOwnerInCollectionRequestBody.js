...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsIsOwnerInCollectionRequestBody = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsIsOwnerInCollectionRequestBody model module.
   * @module model/ModelsIsOwnerInCollectionRequestBody
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsIsOwnerInCollectionRequestBody</code>.
   * @alias module:model/ModelsIsOwnerInCollectionRequestBody
   * @class
   ...
   */
   var exports = function(accountAddress, contractAddress, tokenId,chains) {
  ...
  /**
   * Constructs a <code>ModelsIsOwnerInCollectionRequestBody</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsIsOwnerInCollectionRequestBody} obj Optional instance to populate.
   * @return {module:model/ModelsIsOwnerInCollectionRequestBody} The populated <code>ModelsIsOwnerInCollectionRequestBody</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('account_address'))
        obj.accountAddress = ApiClient.convertToType(data['account_address'], 'String');
   ...
   */
  exports.prototype.accountAddress = undefined;
