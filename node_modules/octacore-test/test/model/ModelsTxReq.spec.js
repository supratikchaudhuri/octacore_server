...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsTxReq', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsTxReq();
      });

      it('should create an instance of ModelsTxReq', function() {
        // TODO: update the code to test ModelsTxReq
        expect(instance).to.be.a(Octacore.ModelsTxReq);
      });
      ...
      it('should have the property endBlock (base name: "end_block")', function() {
        // TODO: update the code to test the property endBlock
        expect(instance).to.have.property('endBlock');
        // expect(instance.endBlock).to.be(expectedValueLiteral);
      });

      it('should have the property startBlock (base name: "start_block")', function() {
        // TODO: update the code to test the property startBlock
        expect(instance).to.have.property('startBlock');
        // expect(instance.startBlock).to.be(expectedValueLiteral);
      });
