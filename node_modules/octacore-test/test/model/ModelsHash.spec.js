...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsHash', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsHash();
      });

      it('should create an instance of ModelsHash', function() {
        // TODO: update the code to test ModelsHash
        expect(instance).to.be.a(Octacore.ModelsHash);
      });
