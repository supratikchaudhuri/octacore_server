...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsBlockNumber', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsBlockNumber();
      });

      it('should create an instance of ModelsBlockNumber', function() {
        // TODO: update the code to test ModelsBlockNumber
        expect(instance).to.be.a(Octacore.ModelsBlockNumber);
      });
