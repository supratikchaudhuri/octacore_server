...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsNonceReq', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsNonceReq();
      });

      it('should create an instance of ModelsNonceReq', function() {
        // TODO: update the code to test ModelsNonceReq
        expect(instance).to.be.a(Octacore.ModelsNonceReq);
      });
