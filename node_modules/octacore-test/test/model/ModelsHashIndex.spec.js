...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsHashIndex', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsHashIndex();
      });

      it('should create an instance of ModelsHashIndex', function() {
        // TODO: update the code to test ModelsHashIndex
        expect(instance).to.be.a(Octacore.ModelsHashIndex);
      });
