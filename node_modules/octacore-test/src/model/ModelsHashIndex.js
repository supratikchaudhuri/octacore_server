...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Octacore.ModelsHashIndex = factory(root.Octacore.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ModelsHashIndex model module.
   * @module model/ModelsHashIndex
   * @version 1.0
   */

  /**
   * Constructs a new <code>ModelsHashIndex</code>.
   * @alias module:model/ModelsHashIndex
   * @class
   * @param hash {String} 
   * @param index {Number} 
   * @param chains {Array.<String>} 
   */
  var exports = function( hash,index,chains) {
    this.hash = hash;
    this.index = index;
    this.chains = chains;
  };
  ...
  /**
   * Constructs a <code>ModelsHashIndex</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ModelsHashIndex} obj Optional instance to populate.
   * @return {module:model/ModelsHashIndex} The populated <code>ModelsHashIndex</code> instance.
   */
