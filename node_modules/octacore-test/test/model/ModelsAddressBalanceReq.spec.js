...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsAddressBalanceReq', function() {
      beforeEach(function() {
        instance = new Octacore.ModelsAddressBalanceReq();
      });

      it('should create an instance of ModelsAddressBalanceReq', function() {
        // TODO: update the code to test ModelsAddressBalanceReq
        expect(instance).to.be.a(Octacore.ModelsAddressBalanceReq);
      });
